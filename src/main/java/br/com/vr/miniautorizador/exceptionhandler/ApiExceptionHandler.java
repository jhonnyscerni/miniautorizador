...
import br.com.vr.miniautorizador.domain.exceptions.BusinessException;
import br.com.vr.miniautorizador.domain.exceptions.ConflictException;
import br.com.vr.miniautorizador.domain.exceptions.EntityInUseException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleEntidadeEmConfito(ConflictException ex, WebRequest request) {
    ...
    public ResponseEntity<?> handleEntidadeEmConfito(UnprocessableEntity ex, WebRequest request) {
